...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    category: 'gauntlet',
    week: 4,
    techStack: ['Swift', 'SwiftUI', 'TypeScript', 'LiveKit', 'MediaPipe', 'OpenRouter', 'Supabase', 'Web Speech API', 'D3.js', 'Hetzner', 'Coolify'],
  ...
  },
  {
    ...
    liveUrl: 'https://nerdy-vid-tutor.46-225-235-124.sslip.io',
    icon: 'folder',
  ...
  },
  {
    ...
    liveUrl: 'https://upstream-community.46-225-235-124.sslip.io',
    icon: 'folder',
  ...
  },
  {
    ...
    liveUrl: 'https://service-core.46-225-235-124.sslip.io',
    icon: 'folder',
