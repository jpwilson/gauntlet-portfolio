...
export const PROJECTS: Project[] = [
  ...
  // ---- OTHER PROJECTS ----
  {
    ...
    longDescription: 'A private social platform for families to connect and share photos, events, and memories in a safe, ad-free environment.',
    category: 'other',
    techStack: [],
  ...
  },
  {
    ...
    longDescription: 'A comprehensive electric vehicle lineup and comparison platform where users can compare specs, pricing, range, and ratings across every EV on the market.',
    category: 'other',
    techStack: [],
  ...
  },
  {
    ...
    longDescription: 'A news platform for aggregating and publishing content from multiple sources into a clean, readable interface.',
    category: 'other',
    techStack: [],
