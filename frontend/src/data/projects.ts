...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    longDescription:
      'A production-ready Model Context Protocol server for SkyFi\'s satellite imagery Platform API. Provides 20 tools that let AI agents search 150+ satellites from 12+ providers (Planet, ICEYE, Umbra, Satellogic, etc.), compare pricing, and order archive or tasking imagery through natural language. Works with any MCP-compatible agent runtime (LangChain, AI SDK, and the major desktop agent clients). Pip-installable as skyfi-mcp.',
    category: 'gauntlet',
    week: 5,
