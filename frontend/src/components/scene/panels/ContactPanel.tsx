...
export const ContactPanel: React.FC = () => (
  <div>
    <p>
      Whether you bring word of new quests, questions about the works within these hills, or simply
    ...
    <div className="me-links" style={{ marginTop: 16 }}>
      ...
      <a className="me-btn ghost" href="https://www.linkedin.com/in/jeanpaulwilson/" target="_blank" rel="noopener noreferrer">
        <LinkedInIcon /> LinkedIn ↗
      </a>
      <a className="me-btn ghost" href="https://x.com/jeanpaulwilson" target="_blank" rel="noopener noreferrer">
        <XIcon /> X ↗
      </a>
    </div>
  </div>
